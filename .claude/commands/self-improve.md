...
2. Review the generated candidate files.
3. If a candidate is human-approved, mark `approved: true` in that candidate file so future runs load it automatically.
